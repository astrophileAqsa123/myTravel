...
const Review = require("./reviews.js");//needed when post method we are making
...
//jb hm listing se review delete krin gy tou listing se tou delete ho jaye ga lekin review schema men phir bhi rhy ga to delete also from review see below code
